...
contract MigrationFacet is Accessibility, IMigrationFacet {
	...
	///      Backfills aggregated positions and funding, the accumulatedPaidFunding baseline, the PartyB total
	///      positions counter, and the PartyA-to-PartyB connection cache.
