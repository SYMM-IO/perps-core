...
library AccountStorage {
	...
	struct Layout {
		...
		mapping(address => mapping(uint256 => bool)) partyBBlacklistedSymbolTypes; // PartyB => symbolType => isDenied
		mapping(address => mapping(uint256 => bool)) partyBBlacklistedSymbols; // PartyB => symbolId   => isDenied
