...
export function shouldBehaveLikeExpressLayerFlows(): void {
	...
	describe("Processing", function () {
		...
		it("STANDARD: blocks payout when globally suspended after finalization and resumes after unsuspension", async function () {
			...
			// Suspension must also block the permissionless fallback after its
			// tolerance period, not only the trusted operator path.
	...
	describe("Per-request fee escrow", function () {
		async function acceptWindowedWithFees(fixture: any, opts: { fee: bigint; operatorFee: bigint }) {
