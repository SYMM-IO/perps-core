/**
 * Bytecode parity verification: deployed core facets vs local compiled artifacts.
 *
 * This is the local-vs-on-chain bytecode gate. It does not publish source/ABI
 * to a block explorer, and it does not check diamond selector wiring.
 *
