/**
 * Publish/verify all deployed upgrade contract source + ABI on a block explorer
 * (Etherscan/Blockscout/Sourcify provider).
 *
 * This is the explorer-publication verification gate. It does not compare local
 * bytecode to deployed bytecode, and it does not check post-upgrade wiring.
 *
...
// Hardhat 3.12 does not export a public type for the verification-provider keys,
// so the supported providers are spelled out here. Keep in sync with
// VERIFICATION_PROVIDERS below.
type VerificationProviderName = "etherscan" | "blockscout" | "sourcify"
...
// ============================================================================
// Library auto-detection (same technique as verifyCoreBytecode.ts)
// ============================================================================
